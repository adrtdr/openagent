...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  ApprovalsRevokeGrantParams: ApprovalsRevokeGrantParamsSchema,
  AuditQueryParams: AuditQueryParamsSchema,
  AuditGetParams: AuditGetParamsSchema,
  AuditExportParams: AuditExportParamsSchema,
  AuditVerifyParams: AuditVerifyParamsSchema,
  CapabilitiesListParams: CapabilitiesListParamsSchema,
  CapabilitiesGetParams: CapabilitiesGetParamsSchema,
  CapabilitiesReloadParams: CapabilitiesReloadParamsSchema,
  RuntimeSnapshotParams: RuntimeSnapshotParamsSchema,
  RuntimeLogsTailParams: RuntimeLogsTailParamsSchema,
  RuntimeLogsStopParams: RuntimeLogsStopParamsSchema,
